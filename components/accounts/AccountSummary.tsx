...
import { valueRenderer, jpyFormatter } from "../../utils/formatter";
    ...
    return loadingOrError({loading, error}) || <Table
        ...
        summary={() =>{
            return <tr>
                <th></th>
                <th></th>
                <th style={{textAlign: "right"}}>{jpyFormatter.format(data!.account_latest_aggregate.aggregate!.sum!.latest_amount!)}</th>
            </tr>
        }}
        columns={[
            {
